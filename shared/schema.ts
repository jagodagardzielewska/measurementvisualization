...
import { pgTable, text, varchar, doublePrecision, timestamp, integer } from "drizzle-orm/pg-core";
...
export type SeriesWithMeasurements = Series & {
  measurements: Measurement[];
};

export type MeasurementWithSeries = Measurement & {
  series: Series;
};
